...
<h1 class="wp-block-heading has-text-align-left"><?php echo esc_html__( 'Error 404, page not found', 'littleboxes' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'The page you were looking for could not be found. It might have been removed, renamed, or did not exist in the first place. Please try searching using the form below.', 'littleboxes' ); ?></p>
<!-- /wp:paragraph -->
