...
/**
 * Title: Recent posts
 * Slug: littleboxes/recent-posts
 * Categories: littleboxes-posts
 * Keywords: recent, latest, posts
 */
?>
<!-- wp:group {"metadata":{"name":"Recent Posts","categories":["littleboxes-posts"],"patternName":"littleboxes/recent-posts"},"style":{"spacing":{"blockGap":"0","margin":{"top":"0","bottom":"64px"}}},"layout":{"type":"constrained"}} -->
...
<h2 class="wp-block-heading has-text-align-left has-secondary-color has-text-color has-link-color" style="font-size:14px;font-style:normal;font-weight:600;letter-spacing:1.6px;line-height:1;text-transform:uppercase"><?php echo esc_html__( 'Recent Posts ¬', 'littleboxes' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:group {"tagName":"main","metadata":{"categories":["littleboxes-patterns"],"patternName":"littleboxes/posts","name":"Posts"},"style":{"spacing":{"margin":{"top":"32px"},"padding":{"top":"0","bottom":"0px","left":"0","right":"0"}},"border":{"radius":"4px","width":"0px","style":"none"}}} -->
