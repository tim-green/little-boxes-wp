...
/**
 * Title: Hero default
 * Slug: littleboxes/hero-default
 * Categories: littleboxes-heroes
 * Keywords: hero
 */
?>
<!-- wp:group {"metadata":{"name":"Hero","categories":["littleboxes-heroes"],"patternName":"littleboxes/hero-default"},"style":{"spacing":{"blockGap":"var:preset|spacing|small","margin":{"top":"32px","bottom":"64px"}}},"layout":{"type":"constrained"}} -->
